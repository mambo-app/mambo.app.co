...
try {
  ...
  await copyFile('mambo apk/mambo.v1.0.6.1.apk', 'public/mambo.v1.0.6.1.apk');
  await copyFile('mambo apk/mambo.v1.0.6.1.apk', 'public/mambo.apk');
  console.log('Copied mambo.v1.0.6.1.apk to public/');
} catch (e) {
